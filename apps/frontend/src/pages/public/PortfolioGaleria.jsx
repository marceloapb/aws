              ...
              <div className="columns-2 md:columns-3 gap-2">
                {fotos.map((foto, idx) => (
                  <button
                    ...
                    className="photo-shield group relative w-full mb-2 overflow-hidden rounded-lg bg-stone-900 block break-inside-avoid focus:outline-none focus:ring-2 focus:ring-[#EA580C]"
                    onContextMenu={e => e.preventDefault()}
                  >
                    <ProtectedImg
