...
const SERVICES_DATA = [
  {
    number: '01', title: 'Casamentos',
    desc: 'Cobertura completa do grande dia — do making-of à festa. Cada sorriso, lágrima e abraço eternizado com a sensibilidade que o momento merece.',
  ...
  {
    number: '02', title: 'Ensaios',
    desc: 'Gestante, família, casal, newborn e muito mais. Sessões pensadas para capturar a essência de cada momento com naturalidade e emoção.',
    detail: 'A partir de R$ 800',
    img: 'https://images.unsplash.com/photo-1769650795757-c901425aefbb?w=600&h=700&fit=crop&auto=format',
    tags: ['Gestante', 'Família', 'Casal', 'Newborn'],
  },
  {
    number: '03', title: 'Eventos',
    desc: 'Corporativos, formaturas, aniversários e celebrações. Imagens que registram a energia e os melhores momentos de cada evento.',
    detail: 'A partir de R$ 1.200',
    img: 'https://images.unsplash.com/photo-1551161440-88a5c5b09ba0?w=600&h=700&fit=crop&auto=format',
    tags: ['Corporativo', 'Formatura', 'Aniversário'],
  },
  {
    number: '04', title: 'Editorial & Urbano',
    desc: 'Fotografia de rua, arquitetura e editorial. Composições pensadas que contam histórias através da geometria das cidades e da poesia dos espaços.',
    detail: 'Sob consulta',
      ...
      <header className="shrink-0 h-16 sm:h-[72px] z-40 grid grid-cols-[1fr_auto_1fr] items-center px-4 sm:px-8 lg:px-16"
        ...
        <nav className="hidden md:flex items-center gap-1.5">
          {SECTIONS.map((name, i) => (
            <button key={name} onClick={() => goTo(i)}
              className="relative px-3.5 py-2 text-[13px] tracking-widest uppercase font-bold transition-colors"
        ...
        <div className="flex items-center justify-end gap-3 sm:gap-4">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <a href="https://wa.me/5511994812037" target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80" style={{ color: '#8a8a8a' }} aria-label="WhatsApp">
            ...
            <a href="https://instagram.com/marcelobloisefoto" target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80" style={{ color: '#8a8a8a' }} aria-label="Instagram">
              <Instagram size={17} />
            </a>
            <a href="#" className="transition-colors hover:opacity-80" style={{ color: '#8a8a8a' }} aria-label="TikTok">
          ...
          {/* Entrar button */}
          <a href="/login" className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-sm font-medium transition-opacity hover:opacity-90"
